...
class ReportController extends Controller
{
    ...
    public function exportToPDF($id)
    {
        ...
        $records = Collector::where('rice_season_id', $this->thisSeasonId)->where('province', $id)->get();
        dd($records);
        if ($records->isEmpty()) {
        ...
        $pdf = Pdf::loadView('report.reportThisWeek', compact('records'))->setPaper('a4', 'landscape');
