...
<div class="space-y-2 2xl:space-y-4">
    ...
    ========================================================== --}}
    <div
        class="relative overflow-hidden rounded-xl border border-primary/20
               bg-gradient-to-br from-primary/5 via-white to-white
               dark:from-primary/10 dark:via-slate-900 dark:to-slate-900
               shadow-sm">
        ...
        <div class="relative p-3.5 sm:p-4">
            ...
            <div class="grid md:grid-cols-2 gap-3 mt-3">
                ...
                <div class="flex items-start gap-2.5">
                    ...
                    <div
                        class="w-7 h-7 shrink-0 rounded-full bg-primary text-white
    ...
    {{-- =========================================================
         DISTRICT PEST SUMMARY
    ========================================================== --}}
    @php

        /*
        |--------------------------------------------------------------------------
        | Centralized Pest Metadata
        |--------------------------------------------------------------------------
        | genus  = abbreviated genus, displayed in italic
        | species = species name, displayed normally
        |--------------------------------------------------------------------------
        */
            ...
            return match (true) {
                $code >= 9 => [
                    'badge' => 'bg-red-50 text-red-700 ring-red-200
                         ...
                         dark:ring-red-500/30 font-bold',
                ...
                $code >= 5 => [
                    'badge' => 'bg-orange-50 text-orange-700 ring-orange-200
                         ...
                         dark:ring-orange-500/30 font-bold',
                ...
                $code >= 1 => [
                    'badge' => 'bg-amber-50 text-amber-700 ring-amber-200
                         ...
                         dark:ring-amber-500/30 font-semibold',
                ...
                default => [
                    'badge' => 'bg-slate-50 text-slate-500 ring-slate-200
                         ...
                         dark:ring-slate-700 font-medium',
    ...
    <div
        ...
        <div
            class="flex items-center justify-between gap-3
                   ...
                   dark:from-slate-800/60 dark:to-slate-900">
            ...
            <div class="flex items-center gap-2.5 min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    <h2
                        class="my-0 py-0 2xl:my-1 2xl:py-1
                               text-base font-bold
                    ...
                    <p
                        ...
                        Last 7 days · averaged risk codes
                ...
                <div class="hidden sm:flex items-center gap-3 shrink-0">
                    ...
                    @foreach ([9 => 'Critical', 5 => 'High', 1 => 'Low', 0 => 'None'] as $code => $label)
                        ...
                        <span
                            ...
                            <span class="w-1.5 h-1.5 rounded-full {{ $lvl['dot'] }}">
                            </span>
        ...
        @if (empty($districtSummaries))
            ...
            <div class="p-8 text-center">
                ...
                <div
                    class="w-12 h-12 bg-slate-100 dark:bg-slate-800
                           rounded-full flex items-center justify-center
                           mx-auto mb-3 text-slate-400">
                    ...
                    <thead>
                        ...
                        <tr class="bg-slate-50 dark:bg-slate-800/60">
                            ...
                            @foreach ($pestMeta as $meta)
                                <th scope="col"
                                    class="px-2.5 py-3 text-center
                                           align-middle min-w-[100px]">
                                    ...
                                    <p
                                        class="text-[10.5px] font-medium my-0 py-0
           text-slate-400 dark:text-slate-500
           leading-tight normal-case">

                                        <em>
                                            {{ $meta['genus'] }} {{ strtolower($meta['species']) }}
                                        </em>
                                ...
                                <td
                                    ...
                                    <i
                                        class="fas fa-location-dot
                                               text-primary/60 mr-1.5 text-xs">
                                    </i>
                    ...
                    <details class="group">
                        ...
                        <summary
                            ...
                            <div class="flex items-center gap-2 min-w-0">
                                ...
                                <i
                                    class="fas fa-location-dot
                                           text-primary/60 text-sm shrink-0">
                                </i>
