<div x-data="{ isOpen: false }">
    ...
    <div x-show.transition="isOpen" @click.away="isOpen = false" class="absolute w-48 origin-top-right right-14">
        <div class="relative z-30 bg-gray-700 border border-gray-100 shadow-xs rounded-b-md">
            <x-dropdown-link href="https://doa.gov.lk/pps-home-sinhala/">DOA Site</x-dropdown-link>
        </div>
