                ...
                @else
                    ...
                    <ul class="space-y-1">
                        @foreach ($selectedCollector->commonDataCollect as $entry)
                            <li class="bg-gray-700 p-1 flex gap-2 border border-gray-600">
                                <span class="text-green-400 font-bold p-0 m-0">{{ $loop->iteration }}.</span>
                                <div class="sm:flex gap-2 text-sm">
                                    <p class=" p-0 m-0"><span class="text-gray-400 p-0 m-0">Field Date:</span>
                                        {{ $entry->c_date }}</p>
                                    <p class=" p-0 m-0"><span class="text-gray-400 p-0 m-0">Submitted:</span>
