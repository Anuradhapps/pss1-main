<x-guest-layout>
    ...
    <x-auth-card>
        ...
        <x-form action="{{ route('register') }}">
            ...
            <p>Use a password manager, we recommend using 1Password for creating and storing passwords or <a
                    href="https://1password.com/password-generator/" target="blank">1password.com/password-generator</a>
            </p>
