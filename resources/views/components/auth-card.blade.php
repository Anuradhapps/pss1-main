<div class="flex min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center overflow-hidden bg-slate-900">
        ...
        <div class="relative z-10 flex flex-col items-center justify-center text-center p-12 text-white">
            <!-- Large Logo -->
            <a href="/"
                class="group flex flex-col items-center mb-8 transform transition-transform hover:scale-105 duration-300">
                <div
                    class="bg-white/10 p-4 rounded-3xl backdrop-blur-sm border border-white/20 shadow-2xl mb-6 group-hover:bg-white/20 transition-colors">
            ...
            <p class="text-lg font-medium text-indigo-100/80 max-w-md mx-auto leading-relaxed drop-shadow-sm mt-4">
                Empowering agricultural officers with real-time data for effective pest monitoring and management across
                Sri Lanka.
            </p>
        </div>
    </div>
    ...
    <div
        class="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-12 bg-surface-light dark:bg-surface-dark z-10 relative lg:rounded-l-3xl lg:shadow-[-20px_0_40px_-15px_rgba(0,0,0,0.1)]">



        <!-- Form Card -->
        <div
            {{ $attributes->merge(['class' => 'w-full max-w-md p-8 sm:p-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-colors duration-300 relative overflow-hidden']) }}>
        ...
        <!-- Footer under form -->
        <div
            class="mt-10 text-center text-sm font-medium text-slate-500 dark:text-slate-400 lg:max-w-md w-full flex flex-col items-center gap-1">
