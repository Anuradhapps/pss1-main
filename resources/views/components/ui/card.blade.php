...
<div {{ $attributes->merge(['class' => "bg-surface dark:bg-card border border-slate-200 dark:border-slate-800 rounded-2xl $shadow transition-all duration-300 relative overflow-hidden group"]) }}>
